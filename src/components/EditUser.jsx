...
const initialValue = { name: "", lastname: "", email: "", rent: "", time: ""}
      ...
      <Box my={5}>
        ...
        <FormGroup>
          ...
          <FormControl>
            ...
            <Input
              onChange={(e) => onValueChange(e)} name="rent"
              value={rent}
            />
          </FormControl>
          <FormControl>
            <InputLabel>Time In eg: 10:30</InputLabel>
            <Input
              onChange={(e) => onValueChange(e)} name="time"
              value={time}
            />
          </FormControl>
          <Box my={3}>
